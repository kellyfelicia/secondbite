...
class TextThemes {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.black), 
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleMedium:const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.white),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.white),
